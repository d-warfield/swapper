...
const allowance_amount = web3.utils.toWei("1000000000000", "ether");
...
contract("", () => {
  beforeEach(async () => {
    ...
    swapzilla = await SwapzillaCore.new([wethAddress]);
  });
  ...
  it("BulkSwap", async () => {
    ...
    await weth.methods
      .approve(swapzilla.address, allowance_amount)
      .send({ from: account });

    const tx1 = await swapzilla.bulkSwapERC20(
      wethAddress,
      [compAddress, batAddress, chainAddress, manaAddress, ampAddress],
      [toWei(1), toWei(1), toWei(1), toWei(1), toWei(1)],
      [toWei(10), toWei(10), toWei(10), toWei(10), toWei(10)],
      toWei(500),
      3000,
      { from: account }
    );
    const tx2 = await swapzilla.bulkSwapERC20(
      wethAddress,
      [compAddress, batAddress, chainAddress, manaAddress, ampAddress],
      [toWei(1), toWei(1), toWei(1), toWei(1), toWei(1)],
      [toWei(10), toWei(10), toWei(10), toWei(10), toWei(10)],
    ...
    const tx3 = await swapzilla.bulkSwapERC20(
      wethAddress,
      [compAddress, batAddress, chainAddress, manaAddress, ampAddress],
      [toWei(10), toWei(10), toWei(10), toWei(10), toWei(10)],
      [toWei(10), toWei(10), toWei(10), toWei(10), toWei(10)],
    ...
    const acct_comp2 = await comp.methods.balanceOf(account).call();
    const acct_weth2 = await weth.methods.balanceOf(account).call();
    console.log(
      `bat balance: ${acct_bat2} comp balance: ${acct_comp2} balance weth: ${acct_weth2}`
    );
